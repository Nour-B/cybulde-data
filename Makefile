...
GCP_DOCKER_IMAGE_NAME = europe-west4-docker.pkg.dev/cybulde-n/cybulde/cybulde-data-processing
...
## process raw data 
process_data: generate-final-data-processing-config push
...
## Push GCP to artifact registery
push: build

...
def get_cmd_to_get_raw_data(
    ...
    Args:
        ...
        data_local_save_dir (str): where to save the downloaded data locally
        dvc_remote_repo (str): dvc repository that holds infomation about the data
        dvc_data_folder (str): location where the remote data is stored
        github_username (str): github user name
        github_acccess_token (str): github access token
